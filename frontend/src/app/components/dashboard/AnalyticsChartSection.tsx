...
import { ChevronRight, BarChart2, BookOpen, Layers } from "lucide-react";
import { Link } from "react-router";

const weekData = [
  { day: "Mon", xp: 120, target: 300 },
  { day: "Tue", xp: 240, target: 300 },
  { day: "Wed", xp: 350, target: 300 },
  { day: "Thu", xp: 280, target: 300 },
  { day: "Fri", xp: 410, target: 300 },
  { day: "Sat", xp: 520, target: 300 },
  { day: "Sun", xp: 380, target: 300 },
];

const monthData = [
  { day: "W1", xp: 1400, target: 2100 },
  { day: "W2", xp: 1850, target: 2100 },
  { day: "W3", xp: 2200, target: 2100 },
  { day: "W4", xp: 2600, target: 2100 },
];

const defaultSubjects = [
  { name: "Physics", pct: 78, color: "#5B5CEB", icon: "⚛️", topics: 24, done: 19 },
  { name: "Chemistry", pct: 64, color: "#36CFC9", icon: "🧪", topics: 20, done: 13 },
  { name: "Mathematics", pct: 85, color: "#7C6BFF", icon: "📐", topics: 28, done: 24 },
  { name: "Biology / Logic", pct: 72, color: "#F59E0B", icon: "🧬", topics: 18, done: 13 },
];
